...
return {
  ...
  ╚══════╝╚═╝  ╚═╝╚══════╝   ╚═╝     ╚═══╝  ╚═╝╚═╝     ╚═╝
    ...
    picker = {
      enabled = true,
      hidden = true,   -- dotfiles global sichtbar
      ignored = true,  -- gitignored Files sichtbar aber gedimmt
      ...
      win = {
        input = {
          keys = {
            ["<C-d>"] = { "toggle_hidden", mode = { "i", "n" } },  -- <C-h> frei für tmux
            ["<C-i>"] = { "toggle_ignored", mode = { "i", "n" } }, -- <C-l> frei für tmux
          },
        },
        list = {
          keys = {
            ["<C-d>"] = { "toggle_hidden", mode = { "i", "n" } },
