...
tmux set -g status-left "#[fg=#7aa2f7,bg=#143652,bold] #{?client_prefix,󰠠 ,#[dim]󰤂 }#[bold,nodim]#S #(~/.config/tmux/scripts/kube.sh) #(~/.config/tmux/scripts/gitops-health.sh) #(~/.config/tmux/scripts/vpn.sh)"
